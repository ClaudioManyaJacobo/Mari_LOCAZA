...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference("Alumno.count") do
      post alumnos_url, params: { alumno: { codigo: @alumno.codigo, edad: @alumno.edad, facultad_id: @alumno.facultad_id, nombre: @alumno.nombre } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { codigo: @alumno.codigo, edad: @alumno.edad, facultad_id: @alumno.facultad_id, nombre: @alumno.nombre } }
