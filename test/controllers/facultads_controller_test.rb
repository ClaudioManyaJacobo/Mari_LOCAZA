...
class FacultadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facultad" do
    assert_difference("Facultad.count") do
      post facultads_url, params: { facultad: { id_facultad: @facultad.id_facultad, nombre: @facultad.nombre } }
    end
  ...
  test "should update facultad" do
    patch facultad_url(@facultad), params: { facultad: { id_facultad: @facultad.id_facultad, nombre: @facultad.nombre } }
