class FacultadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @facultad.save
        format.html { redirect_to facultad_url(@facultad), notice: "Facultad was successfully created." }
  ...
  def update
    respond_to do |format|
      if @facultad.update(facultad_params)
        format.html { redirect_to facultad_url(@facultad), notice: "Facultad was successfully updated." }
  ...
  private
    ...
    def facultad_params
      params.require(:facultad).permit(:id_facultad, :nombre)
    end
end
